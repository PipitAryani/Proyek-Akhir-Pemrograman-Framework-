...
<div class="col-sm-12 text-center">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
    <input class="form-control" type="text" name="notelpon" placeholder="Notelpon"></input>
    </div>
    </div>
    ...
    <div class="col-sm-10">
    <input class="form-control" type="text" name="jeniskelamin" placeholder="jeniskelamin"></input>
    </div>
  </div>
</div>
